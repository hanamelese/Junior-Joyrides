        ...
        Column {
                ...
                Text(
                    text = buildAnnotatedString {
                        withStyle(style = SpanStyle(fontWeight = FontWeight.Bold)) {
                            AnnotatedString.Builder.append("Personal Information: ")
                        }
                        AnnotatedString.Builder.append(" We may collect personal information such as your name, email address, and phone number when you create an account or provide it about your child.")
                    },
                    fontSize = 18.sp,
                    modifier = Modifier.fillMaxWidth()
                )
            ...
            Row(
                ...
                Text(
                    text = buildAnnotatedString {
                        withStyle(style = SpanStyle(fontWeight = FontWeight.Bold)) {
                            AnnotatedString.Builder.append("Child Information: ")
                        }
                        AnnotatedString.Builder.append(" You may provide information about your child, including their name, age, and photos for birthday events.")
                    },
                    fontSize = 18.sp,
                    modifier = Modifier.fillMaxWidth()
                )
            ...
            Row(
                ...
                Text(
                    text = buildAnnotatedString {
                        withStyle(style = SpanStyle(fontWeight = FontWeight.Bold)) {
                            AnnotatedString.Builder.append("Usage Data: ")
                        }
                        AnnotatedString.Builder.append(" We automatically collect information about how you use the app, including device type, operating system, and the features you access.")
                    },
                    fontSize = 18.sp,
                    modifier = Modifier.fillMaxWidth()
                )
